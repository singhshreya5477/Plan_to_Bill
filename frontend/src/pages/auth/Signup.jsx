          ...
          <div className="space-y-4 mb-8">
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <div className="p-6 rounded-xl glass-effect backdrop-blur-xl border border-white/20 shadow-xl animate-fade-in delay-500" style={{ background: 'linear-gradient(180deg, rgba(255,255,255,0.7), rgba(250,246,255,0.5))' }}>
