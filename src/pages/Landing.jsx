        ...
        <section className="container mx-auto px-6 py-20 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="mb-6 animate-fade-in">
              <span className="px-4 py-2 rounded-full text-sm font-semibold gradient-bg-vibrant text-white shadow-lg inline-block">
                🚀 The Complete Project Management Solution
              </span>
            </div>
            <h1 className="text-6xl font-bold mb-6 animate-slide-up" style={{ color: 'rgb(var(--text-primary))' }}>
              From <span className="gradient-text-vibrant">Planning</span> to{' '}
              <span className="gradient-text-primary">Billing</span>
              <br />All in One Place
            </h1>
            ...
            <div className="flex items-center justify-center space-x-4 animate-slide-up delay-200">
              <Link 
                to="/signup" 
                className="px-8 py-4 rounded-xl font-bold text-white gradient-bg-primary shadow-xl hover-lift group text-lg"
              >
                Start Free Trial
